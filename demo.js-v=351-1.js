...
//全局配置
layer.config({
  //extend: 'style.css'/*tpa=http://www.layui.com/layer/moon/style.css*/
});
  ...
  switch(index){
    ...
    case 7:
      ...
      layer.open({
        ...
        fixed: false, //不固定
        maxmin: true,
        content: 'iframe.html'/*tpa=http://www.layui.com/layer/test/iframe.html*/
      });
    break;
    case 8:
      //iframe层-多媒体
      ...
      ,"data": [
        {
          "alt": "layer友情打赏",
          "pid": 666, //图片id
          "src": "layer.jpg"/*tpa=http://res.layui.com/images/pay/layer.jpg*/, //原图地址
          "thumb": "" //缩略图地址
        }
      ]
    }
  ...
  if(!notLayuiAdmin && false){
    layer.open({
      ...
      ,content: ['<div style="padding: 15px; text-align: center; background-color: #e2e2e2;">'
        ,'<a href="https://www.layui.com/admin/std/dist/views/" target="_blank"><img src="168_1527691799254_76462.jpg"/*tpa=http://cdn.layui.com/upload/2018_5/168_1527691799254_76462.jpg*/ alt="layuiAdmin" style="width: 100%; height:149.78px;"></a>'
      ,'</div>'].join('')
      ,success: function(layero, index){
        var btn = layero.find('.layui-layer-btn');
        btn.find('.layui-layer-btn0').attr({
